...
class Downloads extends React.Component {
  ...
  async downloadVideo(id, videoUrl) {
    ...
    const downloadResumable = FileSystem.createDownloadResumable(
      videoUrl,
      FileSystem.documentDirectory + this.getFileName(videoUrl),
      {},
      callback
    );
                    ...
                    >
                      ...
                      !item.isDownloaded ? (
                        <IconButton
                          ...
                          size={30}
                          onPress={() =>
                            this.downloadVideo(item.id, item.videoUrl)
                          }
                        />
                      ) : (
